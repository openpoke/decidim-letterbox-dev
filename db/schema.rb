...
ActiveRecord::Schema.define(version: 20_230_403_182_152) do
  ...
  create_table 'decidim_participatory_documents_documents', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[decidim_author_type decidim_author_id], name: 'decidim_pd_document_author_id_and_type'
  ...
  create_table 'decidim_participatory_documents_suggestions', force: :cascade do |t|
    ...
    t.index %w[decidim_author_type decidim_author_id], name: 'decidim_pd_suggestion_author'
    t.index ['decidim_user_group_id'], name: 'decidim_pd_suggestion_user_group'
    t.index ['state'], name: 'decidim_pd_suggestion_state'
    t.index %w[suggestable_type suggestable_id], name: 'decidim_pd_seggestions_suggestable'
  end
  ...
  create_table 'decidim_participatory_documents_valuation_assignments', force: :cascade do |t|
    ...
    t.index %w[valuator_role_type valuator_role_id], name: 'decidim_pd_valuation_assignment_valuator_role'
  end
  ...
  create_table 'decidim_reporting_proposals_category_valuators', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[decidim_category_id valuator_role_id valuator_role_type], name: 'decidim_reporting_proposals_category_valuator_unique', unique: true
    t.index ['decidim_category_id'], name: 'decidim_reporting_proposals_category_category_id'
    t.index %w[valuator_role_type valuator_role_id], name: 'decidim_reporting_proposals_category_valuator_role'
  end
